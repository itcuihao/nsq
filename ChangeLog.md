...
We now provide a single Docker image [`itcuihao/nsq-note`](https://registry.hub.docker.com/u/itcuihao/nsq-note/)
...
via `github.com/itcuihao/nsq-note/nsqd`, thanks to @kzvezdarov.
 ...
 * #325 - make `nsqd` importable (`github.com/itcuihao/nsq-note/nsqd`) (thanks @kzvezdarov)
...
dependencies.  If you're on go1.1+ you can now just use `godep get github.com/itcuihao/nsq-note/...`.
